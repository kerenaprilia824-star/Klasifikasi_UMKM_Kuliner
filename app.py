"""
Prediksi Adopsi Teknologi UMKM Kuliner Manado
===========================================
"""
...
# Page config
st.set_page_config(page_title="Prediksi UMKM", page_icon="🏪")
...
model_choice = st.sidebar.radio("Pilih Model:",
    ("Random Forest (86.67%)", "Decision Tree (83.33%)"))
...
# Title
st.title("🏪 Prediksi Adopsi Teknologi UMKM")
st.markdown("Masukkan data UMKM Anda untuk prediksi tingkat adopsi teknologi")

# Input form
st.header("📝 Data UMKM")

# Konfigurasi label & pilihan untuk tiap fitur (urut sesuai FEATURE_COLS)
field_options = {
    'pendidikan': ("Pendidikan", ["SD","SMP","SMA","Diploma (D1/D2/D3)","S1"]),
    'lama_usaha': ("Lama Usaha", ["<1","1-2","2-5",">5"]),
    'lokasi_usaha': ("Lokasi", ["Utara","Timur","Barat","Selatan"]),
    'media_penjualan': ("Media Penjualan", ["Offline","Online","Keduanya","Lainnya"]),
    'hari_berjualan': ("Hari Berjualan", ["1-3","4-5","6","7","Tidak tentu","Setiap hari"]),
    'jumlah_karyawan': ("Jumlah Karyawan", ["Sendiri","1-2","3+"]),
    'omzet_bulanan': ("Omzet Bulanan", ["<5jt","5-50jt","50-500jt",">500jt"]),
    'transaksi_per_hari': ("Transaksi/Hari", ["<10","10-20","20-50",">50"]),
    'modal_awal': ("Modal Awal", ["<5jt","5-10jt",">10jt"]),
    'pencatatan_keuangan': ("Pencatatan Keuangan", ["Manual","Digital","Software"]),
    'sumber_modal': ("Sumber Modal", ["Pribadi","Kredit"]),
    'penggunaan_teknologi': ("Penggunaan Teknologi", ["Minimal","Kasir","POS","E-commerce","Advanced"]),
    'memiliki_izin': ("Memiliki Izin", ["Tidak","Ya"]),
    'aktif_promosi_medsos': ("Promosi Media Sosial", ["Jarang","Sering","Sangat sering"]),
    'memiliki_target': ("Memiliki Target", ["Tidak","Ya"]),
    'pernah_pelatihan': ("Pernah Pelatihan", ["Belum","Pernah","Sering"]),
}
